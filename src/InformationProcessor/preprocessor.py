...
from .utils.image_processor import ImageHasher, ImageDescriber
...
class PDFProcessor(ImageDescriber, ImageHasher):
    ...
    def extract_images(self, page_number):
    ...
    @staticmethod
    def get_image_bytes(image_name):
...
def call_pdf_preprocess(pdf_path: str, openai_api: str) -> tuple[str, int]:
    ...
    save_path = save_directory / f'{ebook_name}_extracted_text_{time_stamp_micro}.txt'
